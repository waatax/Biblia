...
| 計畫 | 範圍 | 來源 |
|---|---|---|
| 教會聖經速讀 | 2026 第三季，7/1 ~ 9/30，92 天 | 教會進度表（整理於 `app/data/plan_2026_q3.js`） |
| 每日研經釋義 | 2026 全年，1/1 ~ 12/31，365 天 | [國際讀經會台灣總會](https://www.su101.net/)（貼文 ＋ 官方季表） |

完成狀態存在 localStorage，各份計畫各自獨立計算完成率。
...
第 4 季（10/1 ~ 12/31）進度亦已完整收錄，實現 2026 全年 365 天連續完整無缺日。
