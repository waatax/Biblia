...
- **📅 雙軌讀經計畫**：內建 2026 年每日研經釋義（含聖教會第四季進度，全年 365 天無缺日）與 WOL 教會一年讀完聖經速讀進度，自動打卡與進度統計。
...
| WOL 教會聖經速讀 | 2026 第三季，7/1 ~ 9/30，92 天 | WOL 教會一年讀完聖經進度表（整理於 `app/data/plan_2026_q3.js`） |

完成狀態存在 localStorage，各計畫各自獨立累計連續讀經天數與計算完成率。
