...
- **🍵 禪意專注閱讀模式 (Z)**：按 `Z` 鍵或點擊「🍵 專注」一鍵沉浸於全螢幕經文默想，搭配頂部極細呼吸閱讀進度條。
...
- **✨ 經文深度互動工具箱**：點擊任意節號即可「格式化複製經文」、「單節 11 譯本即時深度對照」、「四色和風螢光標記（山吹/若草/露草/撫子）」與「書籤/靈修筆記」。
- **🔊 Web Speech 多語語音朗讀**：內建語音朗讀播放條，支援中、英、西、法、日、韓、越語文發音跟讀、語速調節（0.75x~1.5x）與經文自動滾動高亮。
- **🔖 個人研經與靈修中心 (B)**：管理閱讀歷程（自動記錄）、我的書籤筆記、螢光經文，並支援一鍵 JSON 匯出備份與還原。
- **✨ 首頁每日精選金句手籤**：每日輪播經典金句手籤，附帶「真理之光」和風朱印、繁中/KJV英文/原文對照、一鍵複製手籤與跳轉查經。
- **📚 讀經會補充資料庫**：完整整合國際讀經會台灣總會《每日研經釋義》季表、66 卷聖經簡介大綱與歷史時間表。
- **📅 雙軌讀經計畫**：內建 2026 年教會聖經速讀與每日研經釋義，自動打卡與進度統計。
- **⌨ 全域鍵盤快捷鍵 (?)**：按 `?` 開啟完整快捷鍵指南（`G` 快選、`Z` 專注、`/` 搜尋、`B` 筆記、`M` 書籤、`T` 主題循環、`I` 逐字、`J`/`K` 滾動、`Space` 朗讀等）。
- **📱 PWA 支援**：支援手機與平板「加入主畫面」，完全離線雙擊即開。
...
| 每日研經釋義 | 2026 年，1/1 ~ 9/30（貼文逐日累積 ＋ 官方季表） | [國際讀經會台灣總會](https://www.su101.net/) |
...
站方是**一天發佈一天**的，未來日期還沒有公開頁面，所以貼文只能抓到「今天為止」；
重跑腳本即可補上新的日子（腳本會檢查日期是否連續，缺日會列出來）。

未來的日子靠 `scripts/data/su101_plan_2026.tsv` 補 —— 那是官方**整季「經文進度表」PDF**
的逐日轉錄（訂戶教會會把 PDF 放上網，例如
[2026 第 3 季](https://togc.org.tw/wp-content/uploads/2026/06/2026-3-%E6%AF%8F%E6%97%A5%E7%A0%94%E7%B6%93%E9%87%8B%E7%BE%A9%E7%B6%93%E6%96%87%E9%80%B2%E5%BA%A6.pdf)）。
貼文永遠優先，季表只填還沒發佈的日子；**重疊的日子會互相對帳**，不一致就會警告
（現況：7/1~8/12 共 43 天完全一致）。要往後延到年底，就把第 4 季 PDF
（站方約於季初前一個月釋出）照同格式續寫進 TSV，再重跑腳本即可。
